...
public abstract class AbstractArtGallery implements IAddPainting {
    ...
    protected ArrayList<Sculpture> sculptures = new ArrayList<Sculpture>();
    ...
    public void addPainting(String fileName, Painting newPainting) {
        ...
        catalogItem(fileName, newPainting.getName(), newPainting.getPainterName(), newPainting.getPrice());
    }
    ...
    @Override
    public void catalogItem(String fileName, String itemName, String itemCreatorName, int price) {
       ...
       PrintWriter catalog;
        try {
            ...
            catalog.println(itemName+" by "+itemCreatorName+ " for "+price);
