...
REAL :: diaInside, diaLarge, length, boardFeet, volume
...
call getLOGdata(diaInside, diaLarge, length, KERF)
call JCLARK(diaInside,diaLarge,length,KERF,boardFeet)
...
SUBROUTINE getLOGdata(diaInside, diaLarge, length, KERF)

REAL :: diaInside, diaLarge, length

WRITE (*,*) "Enter the diameter inside bark at the log’s small end in inches"
READ (*,*) diaInside
WRITE (*,*) "Enter the diameter inside bark at the log's large end in inches"
READ (*,*) diaLarge
