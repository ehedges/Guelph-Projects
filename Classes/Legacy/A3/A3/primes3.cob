...
77  inputFileName pic x(999).
77  outputFileName pic x(999).
...
*> User prompt for files filenames

    display " Welcome to this prime calculation program. Please enter your data with a filename less that 999 Characters".
    accept inputFileName.
    display " Please enter the solution filename with less than 999 characters. ".
