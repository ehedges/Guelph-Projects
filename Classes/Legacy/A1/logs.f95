...
REAL :: taper, vadd, sectionLarge, diameterScale, diameterExtra, diamaterCalc, counterLarge, XL
...
XL=counterLarge-1.0
diameterExtra=diaSmall+(taper/4.0)*(totalLength-sectionLarge-XL)
VADD=0.055*XL*diameterExtra*diameterExtra-0.1775*XL*diameterExtra
...
DO I=1,footSegements
    ...
    volume =volume +0.22*diamaterCalc*diamaterCalc-0.71*diamaterCalc
...
REAL :: radSmallM, radLargeM, meterLength, areaSmall, areaLarge, sectionLarge, counterLarge,XL
...
! OF LENGTH ARE IN THE SEGMENT LESS THAN 4 FEET LONG.
    ...
    XL=counterLarge-1.0
    diaLarge = diaSmall + ((XL+footSegements)*0.5)
...
!Areas calculation
areaSmall = pi* radSmallM* radSmallM
areaLarge = pi* radLargeM* radLargeM
